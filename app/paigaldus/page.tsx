  ...
  <div className="max-w-5xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      >
        ...
        <p className="text-gray-600 mb-4">Kiire hädaabi 1–2 tunni jooksul.</p>
      ...
      >
        ...
        <p className="text-gray-600 mb-4">Katlakivi eemaldus ja anoodi vahetus.</p>
        <span className="text-blue-600 font-semibold">Vaata lähemalt →</span>
      </Link>
      ...
      <Link 
        ...
        className="block bg-white shadow-sm p-6 rounded-xl border border-gray-200 hover:shadow-lg hover:-translate-y-1 transition"
      >
        <h3 className="text-xl font-semibold mb-2">Hädaabi 24/7</h3>
