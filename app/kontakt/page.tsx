<section className="w-full bg-white/70 backdrop-blur-sm p-10 rounded-2xl shadow-xl border border-gray-200 mt-12 space-y-16">
  ...
  <div className="text-center">
    ...
    <div className="flex justify-center gap-4 mt-6">
      ...
      <a
        href="/kontakt"
        className="px-6 py-3 border border-primary-400 text-primary-700 text-lg rounded-xl hover:bg-primary-50 transition"
      >
        Saada päring
      </a>
    </div>
