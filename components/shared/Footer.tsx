  ...
  return (
    ...
    >
      ...
      >
        <LandingFooterLink
          href="/paigaldus"
          className="group flex items-center gap-2 transition-all duration-200 hover:translate-x-1"
        >
      ...
      >
        <div className="group flex items-center gap-3 p-2 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm">
          ...
          <a href="tel:+37253684587" className="font-medium text-gray-800 hover:text-red-600 transition-colors">
            +372 5368 4587
          </a>
        </div>
        ...
        <div className="group flex items-center gap-3 p-2 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm">
          ...
          <a href="mailto:info@prism.ee" className="font-medium text-gray-800 hover:text-blue-600 transition-colors">
            info@prism.ee
          </a>
        </div>

        <div className="group flex items-center gap-3 p-2 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm">
          <div className="flex items-center justify-center w-8 h-8 bg-gray-50 rounded-full group-hover:bg-gray-100 transition-colors">
        ...
        <div className="pt-4 mt-4 border-t border-gray-100">
          ...
          >
            <div className="flex items-center justify-center w-6 h-6 bg-green-50 rounded-full group-hover:bg-green-100 transition-colors">
      ...
      >
        {[
          { href: "https://www.facebook.com/boileriabi.ee", label: "Facebook", emoji: "📘", color: "blue" },
          { href: "https://www.instagram.com/the.vzglyad_/", label: "Instagram", emoji: "📷", color: "pink" },
          { href: "https://www.tiktok.com/@the.vzglyad_", label: "TikTok", emoji: "🎵", color: "black" }
        ].map((social) => (
          <a
            key={social.href}
            href={social.href}
            target="_blank"
            rel="noopener noreferrer"
            className={`group flex items-center gap-3 p-2 rounded-lg transition-all duration-200 hover:bg-white hover:shadow-sm ${
              social.color === 'blue' ? 'hover:text-blue-600' :
              social.color === 'pink' ? 'hover:text-pink-600' :
              'hover:text-gray-900'
            }`}
          >
            <div className={`flex items-center justify-center w-8 h-8 rounded-full transition-colors ${
              social.color === 'blue' ? 'bg-blue-50 group-hover:bg-blue-100' :
              social.color === 'pink' ? 'bg-pink-50 group-hover:bg-pink-100' :
              'bg-gray-50 group-hover:bg-gray-100'
            }`}>
              <span className="text-sm">{social.emoji}</span>
            </div>
            <span className="font-medium text-gray-800 group-hover:text-inherit transition-colors">
              {social.label}
            </span>
          </a>
        ))}
        ...
        <div className="pt-4 mt-4 border-t border-gray-100">
          ...
          <Link
            href="/hinnad"
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white text-sm font-medium rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-200 shadow-sm hover:shadow"
          >
            <span>💬</span>
            Saada päring
          </Link>
